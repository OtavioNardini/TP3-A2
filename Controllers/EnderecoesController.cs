...
namespace RestauranteAPP_TP3.Controllers
{
    ...
    public class EnderecoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UsuarioId,Rua,Cidade,CEP")] Endereco endereco)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Users, "Id", "Id", endereco.UsuarioId);
            return View(endereco);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UsuarioId,Rua,Cidade,CEP")] Endereco endereco)
        {
            if (id != endereco.Id)
            {
                return NotFound();
